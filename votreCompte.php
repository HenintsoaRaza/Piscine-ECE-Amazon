...
<div class="rectangle container-fluid">
	...
	<h3 class="feature-title-votre-compte">Se connecter :</h3> <br>

<form action="coClient.php" method="POST">
<div class="form-group" action="votreCompte.php" >
...
<input type="submit" class="btn btn-secondary btn-block" value="Se connecter" name="connexion">
</form>
</div>
</div>
</div>
