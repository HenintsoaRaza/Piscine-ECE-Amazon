...
<nav class="navbar navbar-expand-md">
 ...
 <li class="nav-item dropdown">
    ...
    <a class="dropdown-item" href="CategorieVetements.php">Vetement <i class="fa fa-shopping-bag" aria-hidden="true" ></i></a>
     <a class="dropdown-item" href="CategorieMusique.php" style="color: red;">Musique <i class="fa fa-music" aria-hidden="true" style="color: red;"></i></a>
...
<?php 
	page_articles("musique",$db_handle);
?>
