...
<body>
	<form action="coadmin.php" method="post">
<nav class="navbar navbar-expand-md">
 ...
 <li class="nav-item"><a class="nav-link" href="admin.php" style="color: red;"><i class="fa fa-lock" aria-hidden="true"></i> Admin </a></li>
    <?php
...
<div class="rectangle container-fluid">
 	<h3 class="feature-title-votre-compte">Connectez-vous en tant que Admin :</h3> <br>
...
<input type="submit" class="btn btn-secondary btn-block" value="Se connecter" name="Rechercher">
 </div>
</div>
</div>
</div>
